...
function setup() {
    ...
    makeNewTetramino(type);
    gameLoop();

    function makeNewTetramino(type) {
        let possible = "OISZJLT".replace(type, "");
        type = possible.charAt(Math.floor(Math.random() * 7));
    ...
    function sjekkForLinjer(brett){
        ...
        // i en løkke endres indeks etter en fast regel
