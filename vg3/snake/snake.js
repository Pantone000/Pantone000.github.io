...
function startGame() {
    ...
    setTimeout(rellyStartTheGame, 0.1 * 1000);
    ...
    btnOmstart.addEventListener("click",rellyStartTheGame);



    function rellyStartTheGame() {
        divBoard.innerHTML = "";
    ...
    function sjekkSlange(){
        ...
        for (let i=0; i<segments.length; i++) {
            ...
            if (s.pos.x === h.pos.x && s.pos.y === h.pos.y){
                ...
                divBoard.innerHTML = "Game Over" + "<br>" + poeng + " " + "poeng";
